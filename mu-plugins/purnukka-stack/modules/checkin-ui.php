<?php
/**
 * Module: Check-in UI (v1.6.5 MASTER)
 * Refactor: Constructor Injection.
 * Status: Alkuperäinen hintalogiikka ja visuaalisuus säilytetty täysin muuttumattomana.
 */
...
class Purnukka_Checkin_Ui {
    private $core;
    private $sku = 'purnukka-extra-guest-fee';
    ...
    public function __construct($core) {
        ...
        $this->init_cart_cleaner();
        
        // Rekisteröidään shortcode
        add_shortcode('purnukka_checkin', [$this, 'render_checkin_ui']);
    }
    ...
    private function get_product_id() {
        ...
        // Luodaan tuote automaattisesti, jos sitä ei löydy
    ...
    private function init_cart_cleaner() {
        // Ostoskorin tyhjennyslogiikka
        add_filter('woocommerce_add_cart_item_data', function($cart_item_data, $product_id) {
            $target_id = $this->get_product_id();
    ...
    public function render_checkin_ui($atts) {
        $dynamic_id = $this->get_product_id();
        
        // Haetaan värit keskitetysti coren konfiguraatiosta
        $purnukka_config = $this->core->config;
        ...
        function calculateTotalAmount() {
            ...
            // SÄILYTETTY: Alkuperäinen kovakoodattu hintalogiikka
            let unitPrice = 30;
