...
class PurnukkaStackCore {
    public function __construct() {
        ...
        // Pakotetaan logoasetukset lennosta laskettaessa
    ...
    public function force_branding_into_pdf($settings) {
        ...
        if ($logo_id) {
            ...
            if (empty($settings['header_logo_height'])) $settings['header_logo_height'] = '30';
        }
        return $settings;
    }
...
function purnukka_sync_master_data() {
    ...
    // Pakotetaan objektit debugger-löydösten perusteella
...
function render_pukka_settings() {
    ...
    ?>
    <div class="wrap">
        <h1 style="color:#c5a059;">Purnukka Stack v0.39</h1>
        <hr>
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr><th>SMTP Host / User / Pass</th><td>
                    <input type="text" name="p_smtp_host" value="<?php echo esc_attr(get_option('p_smtp_host')); ?>" style="width:140px">
                    <input type="text" name="p_smtp_user" value="<?php echo esc_attr(get_option('p_smtp_user')); ?>" style="width:140px">
                    <input type="password" name="p_smtp_pass" value="<?php echo esc_attr(get_option('p_smtp_pass')); ?>" style="width:140px">
                </td></tr>
            </table>

            <h3>3. Legal & World SPoT</h3>
            <table class="form-table">
                ...
                <tr><th>Maintenance Mode</th><td><input type="checkbox" name="p_maintenance_mode" value="on" <?php checked(get_option('p_maintenance_mode'), 'on'); ?>> Enable</td></tr>
            </table>
            <?php submit_button('Save & Sync All Global Data'); ?>
        </form>
    </div>
    <?php
}
